...
public class V1_VisualAITests extends MainClass{

	WebDriverWait wait;
	@Test(priority = 1)
	public void AppliV1_loginPageUIElementTest() throws Exception {
	...
	public void AppliV1_dataDrivenTest(String username, String password) throws Exception {
	...
	@Test(priority = 3)
	public void AppliV1_TableSortingTest() throws Exception {
		driver.navigate().to(CONFProp.getProperty("HackathonV1BASEURL"));
		wait = new WebDriverWait(getDriver(), 60);
		wait.until(ExpectedConditions.presenceOfElementLocated(By.id("username")));
	...
	@Test(priority = 4)
	public void AppliV1_CanvasChartTest() throws Exception {
	...
	@Test(priority = 5)
	public void AppliV1_DynamicContentTest() throws Exception {
